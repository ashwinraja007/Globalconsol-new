...
const AirFreight = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const { data } = await supabase.from('service_pages_content').select('*').eq('slug', 'air-freight').single();
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-blue-600/20 px-6 py-3 rounded-full mb-6 mt-9">
              ...
              <span className="text-blue-500 font-semibold">Air Freight Services</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Air <span className="text-blue-500">Freight</span>
            </h1>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            >
              ...
              <img src={pageData?.image_url || "/airfreight.png"} alt="Air Freight Services" className="w-full h-96 object-cover" />
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-3xl font-bold text-blue-500">{pageData?.title || "Leading Air Freight Solutions"}</h2>
              {pageData?.content ? (
